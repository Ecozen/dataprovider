...
public class ExcelDataReader implements ExcelDataSource {
	   ...
	   */
	  public ExcelDataReader(XSSFSheet sheet, Boolean has_headers, Boolean has_key_column, Integer key_column) {
	  ...
	  /**
	   * self condition methods
	   */
	  public void readBySheet(XSSFSheet sheet){
	  ...
	  public void readByRow(XSSFSheet sheet,int rowNum){
	  ...
	  public void readByColumn(XSSFSheet sheet,String columnName){
		  for (Row row: sheet) {
